...
const ScholarsProTeaser: React.FC = () => {
  ...
  const schools = [
    ...
    { name: "UNN", fullName: "University of Nigeria, Nsukka", image: "/un.png" },
  ...
  const buttonStyles = getDynamicButtonStyles(scholarsData.buttonText);
  const dynamicButtonVariants = getDynamicButtonVariants(scholarsData.buttonText);
            ...
            <motion.div variants={itemVariants} className="mb-8 sm:mb-16">
              ...
              >
                ...
                <span className="relative z-10 flex items-center justify-center">
                  {buttonStyles.icon}
                  <span className="whitespace-nowrap">{scholarsData.buttonText}</span>
                  <motion.div
...
const getDynamicButtonStyles = (buttonText: string) => {
  ...
  if (isTelegram) {
    return {
      gradient: "bg-gradient-to-r from-[#9300FF] to-purple-600",
    hoverGradient: "from-purple-400 to-[#9300FF]",
    shadow: "0 4px 20px rgba(147, 0, 255, 0.3)",
    hoverShadow: "0 8px 30px rgba(147, 0, 255, 0.5)",
  ...
  // Default to purple (matching Scholars Pro theme)
  return {
    gradient: "bg-gradient-to-r from-[#9300FF] to-purple-600",
    hoverGradient: "from-purple-400 to-[#9300FF]",
    shadow: "0 4px 20px rgba(147, 0, 255, 0.3)",
